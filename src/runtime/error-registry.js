...
export const ADAPTER_ERROR_REGISTRY = Object.freeze([
	...
	Object.freeze({
		...
		messagePrefix: direct('cluster.worker-error', 'A worker thread reported an error.'),
	...
	Object.freeze({
		...
		messagePrefix: direct('cluster-relay.up-spill-overflow', 'This worker could not hand its relay backlog to the primary within its spill ceiling and is exiting to be replaced.'),
	...
	Object.freeze({
		...
		messagePrefix: direct('cluster-relay.frame-oversized', 'A worker sent a relay frame larger than this process will reassemble; its relay stream was stopped.'),
	...
	Object.freeze({
		...
		messagePrefix: direct('cluster-relay.frame-refused', 'A publish was too large for the cluster relay and was not sent to other workers. Local subscribers received it.'),
